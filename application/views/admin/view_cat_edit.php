  ...
  <div class="content-wrapper">
    ...
    <img src="<?php echo base_url(); ?>uploads/category-details/<?php echo $val['cat_detail_imge']; ?>" width="50" height="50">
    <br/>
    
    <label for="last name"><b>Category Detail alt Title:</b></label>
    <input type="text"  name="cat_dt_alt_title" value="<?php echo $val['cat_detail_alt_title']; ?>" class="form-control">
    <br/> 
