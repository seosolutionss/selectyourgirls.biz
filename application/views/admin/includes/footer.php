 <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">isabasu.com</a>.</strong> All rights
...
<script src="<?php echo base_url(); ?>assets/js/admin/Chart.js"></script>

<!-- AdminLTE dashboard demo (This is only for demo purposes) -->

<script src="<?php echo base_url(); ?>assets/js/admin/dashboard2.js"></script>
