    ...
    <table id="example" class="table table-striped table-bordered" style="width:100%;padding-left:1%;">
        ...
        <tbody> 
            ...
            <tr>
                ...
                <td><a href="<?php echo base_url(); ?>users/edit/<?php echo $val['id']; ?>">Edit</a>/<a onclick="del_confirm('<?php echo $val['id']; ?>');" href="#">Delete</a></td>
 ...
 <script>
...

   {
...

       {
           ...
           window.location.href="<?php echo base_url(); ?>users/del/"+val;
